...
class PermissionManager:
    ...
    def requires_approval(tool_name: str, args: dict) -> bool:
        ...
        write_tools = ["write_to_file", "str_replace_file", "create_file", "delete_file"]
        if tool_name not in ["execute_command", *write_tools]:
            return False
            ...
            if tool_name in write_tools:
                ...
                if cmd:
                    whitelist = [
                        ...
                        "pnpm run build", "pnpm test", "pnpm run dev", "pnpm dev", "pnpm start", "pnpm install",
