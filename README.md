...
Một avatar Live2D luôn hiện trên màn hình, kéo được, click để nói chuyện. Mỗi khi AI trả lời, avatar thay đổi biểu cảm theo từng câu — cười, ngạc nhiên, dỗi, vui — miệng chuyển động theo âm thanh. AI tự nhớ thông tin về mày, thay đổi tâm trạng theo thời gian, và chủ động lên tiếng khi thấy mày im lặng quá lâu.
