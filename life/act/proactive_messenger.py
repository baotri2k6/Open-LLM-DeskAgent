...
class ProactiveMessenger:
    ...
    async def send(self, action_type: str, message_hint: str) -> bool:
        ...
        """
        trigger_prompt = _HINT_PROMPTS.get(message_hint)
        if trigger_prompt is None:
            trigger_prompt = message_hint or _DEFAULT_HINT
        ...
        try:
            ...
            async for chunk in llm.chat_stream(
                ...
                if isinstance(chunk, str):
                    ...
                    logger.debug("ProactiveMessenger: Ignoring unexpected chunk type %s", type(chunk).__name__)
